...
public final class CommandConstants {
    ...
    public static final int WRIST_PICKUP_ENCODERVALUE = 10; //TODO: FIX

    public static final int INTAKE_LEVEL_ONE = 0; //TODO: FIX
    public static final int INTAKE_LEVEL_TWO = 24; //23.833 repeating
    public static final int INTAKE_LEVEL_THREE = 37; //36.66 repeating
